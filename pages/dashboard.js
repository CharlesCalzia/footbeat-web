...
const stats = [
  { name: 'Calories burnt', value: '2,392', change: '+2.75%', changeType: 'positive' },
  { name: 'Steps', value: '2,300', change: '-60.02%', changeType: 'negative' },
  { name: 'Hrs of sleep', value: '0', change: '-100.00%', changeType: 'positive' },
  { name: 'Active minutes', value: '23', change: '-10.18%', changeType: 'negative' },
]
        ...
        try {
          const response = await fetch(
            "https://api.tryterra.co/v2/activity?user_id=" +
              "09e7d9f7-a441-4bea-a637-911807d3aaa9" +
